...
st.title("Cardiovascular Diseases Prediction App")
st.markdown("""
 This is an app where you can find the **Probability of having Cardiovascular Disease** based on a series of features. The predictions are powered by a **Supervised Machine Learning - Random Forest Classification Model**, which was trained on a dataset of 918 examples. 
